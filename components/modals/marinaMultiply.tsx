...
interface MarinaMultiplyModalProps {
  contract: Contract
  data: string
  result: string
  retry: () => void
...
const MarinaMultiplyModal = ({
  ...
  return (
    <Modal id={ModalIds.MarinaMultiply} reset={reset}>
      <ModalContent />
    </Modal>
  )
}

export default MarinaMultiplyModal
